...
func siteHeader() string {
	...
	const sunIcon = `<svg class="bf-theme-sun" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>`
	const moonIcon = `<svg class="bf-theme-moon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>`

	return `<header class="bf-header">
    <div class="bf-header-inner">
        <div class="bf-header-left">
            <a href="https://barefootjs.dev" class="bf-header-logo">Barefoot.js</a>
            <div class="bf-header-sep"></div>
            <nav class="bf-header-nav">
                <a href="https://barefootjs.dev/docs/introduction" class="bf-header-link">Core</a>
                <a href="https://ui.barefootjs.dev" class="bf-header-link">UI</a>
                <a href="https://barefootjs.dev/playground" class="bf-header-link">Playground</a>
            </nav>
        </div>
        <div class="bf-header-right">
            <a href="https://github.com/barefootjs/barefootjs" target="_blank" rel="noopener noreferrer" class="bf-header-icon-btn" aria-label="View on GitHub">` + githubIcon + `</a>
            <button type="button" class="bf-header-icon-btn" data-bf-theme-toggle aria-label="Toggle theme">` + sunIcon + moonIcon + `</button>
        </div>
    </div>
</header>`
}
...
%s%s
    <div id="app">%s</div>
    <p><a href="%s">← Back</a></p>
    <script src="%s/shared/scripts/theme-toggle.js" defer></script>
    %s%s
</body>
</html>`, ctx.Title, themeInitScript, basePath, basePath, basePath, basePath, extraCSS, siteHeader(), headingHTML, ctx.ComponentHTML, basePath, basePath, ctx.Portals, ctx.Scripts)
}
...
</html>`, themeInitScript, basePath, basePath, basePath, siteHeader(), body, basePath))
}
