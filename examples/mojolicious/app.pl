...
$r->get('/scripts/*asset' => sub ($c) {
    $c->reply->static('scripts/' . ($c->stash('asset') // '')) or $c->reply->not_found;
});
...
% my $theme_init = q{(function(){try{var s=localStorage.getItem('theme');var d=window.matchMedia('(prefers-color-scheme: dark)').matches;if(s==='dark'||(s!=='light'&&d)){document.documentElement.classList.add('dark')}}catch(e){}})();};
<!DOCTYPE html>
<html lang="ja">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <script src="<%= $bp %>/scripts/theme-toggle.js" defer></script>
    <%== bf->scripts %>
    <%== bf_dev_snippet %>
</body>
</html>
...
<header class="bf-header">
    <div class="bf-header-inner">
        ...
        <div class="bf-header-right">
            <a href="https://github.com/barefootjs/barefootjs" target="_blank" rel="noopener noreferrer" class="bf-header-icon-btn" aria-label="View on GitHub">
            ...
            <button type="button" class="bf-header-icon-btn" data-bf-theme-toggle aria-label="Toggle theme">
                <svg class="bf-theme-sun" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>
                <svg class="bf-theme-moon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
            </button>
        </div>
    </div>
</header>
