...
export function Header({ activePage, searchSlot, leftSlot, themeSwitcher }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-[var(--header-height)] bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
