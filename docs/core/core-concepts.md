...
| Topic | Description |
|-------|-------------|
| [Two-Phase Compilation](./core-concepts/compilation.md) | The compiler transforms JSX into a server template and client JS via an intermediate representation |
