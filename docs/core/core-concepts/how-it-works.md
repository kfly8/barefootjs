---
title: How It Works
description: Two-phase compilation, hydration markers, and CSS layer overrides
---
...
## Clean Overrides via CSS Layers

User-supplied classes always override component base classes — guaranteed by CSS Cascade Layers.
